...
test('Find Internal Links Only', () => {
  expect(links.findInternal('<a href="/index.html">Blah</a><a href="https://google.ca">Google</a>', domain, current)[0]).toBe('https://jesseconner.ca/index.html');
});

test('Find External Links Only', () => {
  expect(links.findExternal('<a href="/">Blah</a><a href="https://google.ca">Google</a>', domain)[0]).toBe('https://google.ca/');
});
...
test('Unsupported protocols get skipped', () => {
  expect(links.find('<a href="ftp://hello@gmail.com">Boo</a>', domain).length).toBe(0);
});
